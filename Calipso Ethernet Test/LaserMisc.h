...
#ifdef ONE_CONNECTOR
#define __MISC_LASERLED2_ON()		HAL_GPIO_WritePin(GPIOB, GPIO_PIN_LaserLED,        GPIO_PIN_SET)
#else
...
#ifdef ONE_CONNECTOR
#define __MISC_LASERLED2_OFF()	HAL_GPIO_WritePin(GPIOA, GPIO_PIN_LaserLED,         GPIO_PIN_RESET)
#else
