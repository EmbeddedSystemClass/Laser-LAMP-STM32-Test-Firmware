...
int Init_MainSPI_Thread (void) {
  ...
  Driver_SPI2.Control(ARM_SPI_MODE_MASTER | ARM_SPI_CPOL1_CPHA1 | ARM_SPI_MSB_LSB | ARM_SPI_SS_MASTER_UNUSED | ARM_SPI_DATA_BITS(16), 1000000);
...
{
	uint16_t data = ~(uint16_t)((value / 10.0f) * 2048.0f);
